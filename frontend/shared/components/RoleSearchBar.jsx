...
const RoleSearchBar = ({ activeRole }) => {
  ...
  return (
    <div className="hidden sm:block flex-1 max-w-[300px] xl:max-w-[350px] w-full relative" ref={searchRef}>
      ...
      <input
        ...
        className="w-full pl-10 pr-4 py-2 bg-[#f3f4f6] dark:bg-[#111c18] border border-slate-200/80 dark:border-[#2a4038] rounded-full text-sm font-semibold text-gray-700 dark:text-[#a3b3af] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00a76b]/20 focus:bg-white dark:focus:bg-[#162722] transition-all"
      />

      {isOpen && debouncedQuery.trim().length > 0 && (
        <div className="absolute top-[45px] left-0 w-[300px] sm:w-[350px] bg-white dark:bg-[#0c1512] border border-[#eceae3] dark:border-[#1a2d29] rounded-[20px] shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden z-[110] max-h-[400px] overflow-y-auto p-4 space-y-2">
